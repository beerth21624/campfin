    ...
    <div className="d-flex justify-content-center ">
      <div className="about-container">
        ...
        <div className="d-flex flex-column align-items-center p-5 ">
          <div className="title">about camphin</div>
          <div className="subtitle">Camphin service</div>
          <div className="description">
            Camphin is a community for people who dslove hiking and camping. We
            provide a platform for people to share their experience and
            knowledge. We also provide a feature that enables us to meet people
            from all around the world who share our passion in hiking and
            camping.
          </div>
